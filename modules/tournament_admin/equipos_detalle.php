<?php
/**
 * Página de Detalle de Equipos del Torneo (Fuera de Podio)
 * Muestra información detallada de equipos con información de cada jugador y estadísticas del equipo
...
// Función helper para obtener color de fondo (gris para equipos fuera de podio)
function getEquipoBgClass($posicion) {
    if ($posicion <= 3) {
        // Si está en podio, usar colores de podio
        switch ($posicion) {
...
<div class="min-h-screen bg-gradient-to-br from-purple-600 via-purple-700 to-indigo-800 p-6">
    ...
    <div class="bg-white rounded-xl shadow-lg p-6 text-center">
        <div class="text-gray-600">
            ...
            <p class="text-lg">Aún no hay equipos registrados en este torneo.</p>
        </div>
    </div>
    <?php else: ?>
                ...
                <div class="<?= getEquipoBgClass($equipo['posicion']) ?> p-6" style="font-family: 'Inter', 'Segoe UI', system-ui, sans-serif;">
                    ...
                    <div class="text-center mb-3">
                        <h2 class="text-2xl font-extrabold drop-shadow-lg text-black tracking-wide">
                            ...
                            <?php else: ?>
                                <i class="fas fa-users mr-2"></i>EQUIPO <?= htmlspecialchars($equipo['codigo_equipo']) ?> - POSICIÓN <?= $equipo['posicion'] ?>
                            <?php endif; ?>
                        </h2>
                    </div>
...
function seleccionarEquipo(codigoEquipo) {
    ...
    // Redirigir a la misma página con el código del equipo seleccionado
