...
try {
    ...
    $mid = FvdDelegadoMovimientoService::solicitarCarnet($pdo, $userId, $torneoId, (int) $club['id']);
    echo json_encode(['ok' => true, 'message' => 'Solicitud de carnet registrada (ref. #' . $mid . ').', 'movimiento_id' => $mid]);
} catch (Throwable $e) {
