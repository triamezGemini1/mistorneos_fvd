...
<div class="tw-panel ds-root">
    ...
    <div class="mb-2 text-center">
        <button type="button" id="btnCronometroVentana" class="transition-all">
            Activar cronómetro
        </button>
        <?php
...
(function() {
    ...
    /** Importación masiva: si el servidor devolvió JSON con success:false o HTTP de error, lanza para ir al catch y ocultar “Procesando”. */
